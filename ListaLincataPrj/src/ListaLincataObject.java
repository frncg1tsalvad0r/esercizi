public class ListaLincataObject {
    private NodoObject testa = null;
    private int contaNodi;
    
    public ListaLincataObject() {
        this.testa = null;
        this.contaNodi = 0;
    }
    ...
    public void addFirst(Object dato){
        NodoObject nuovo = new NodoObject();
        nuovo.valore = dato;
    ...
    public String toString() {
        String s = "";
        NodoObject corrente = this.testa;
     ...
     * @param valore
     */
    public void add(int posizione, Object valore) {
